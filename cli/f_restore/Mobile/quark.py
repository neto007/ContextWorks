...
def run_quark(
    ...
    job_id = os.environ.get("WM_JOB_ID", "local_test_quark")
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"DEBUG: Running Quark-Engine on {filename}...", file=sys.stderr, flush=True)
...
def main(file_content: bytes = b"", filename: str = "test.apk"):
    ...
    print(json.dumps(run_quark(file_content, filename), indent=2), flush=True)
