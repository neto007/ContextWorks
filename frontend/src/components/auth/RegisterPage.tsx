        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#050101] text-[#f8f8f2] font-['JetBrains_Mono']">
            ...
            <div className="w-full max-w-md p-8 relative z-10">
                <div className="mb-8 text-center animate-fade-in-down">
                    ...
                    <p className="text-[#6272a4]">Join ContextWorks today</p>
                </div>
                ...
                <div className="bg-[#1a1b26]/80 backdrop-blur-xl rounded-xl border border-[#bd93f9]/20 p-8 shadow-2xl animate-fade-in-up">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-[#f8f8f2] ml-1">Full Name</label>
                            <div className="relative group">
                                <User className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6272a4] group-focus-within:text-[#bd93f9] transition-colors" size={18} />
                                <input
                                    id="fullName"
                                    type="text"
                                    value={fullName}
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-[#f8f8f2] ml-1">Password</label>
                            <div className="relative group">
